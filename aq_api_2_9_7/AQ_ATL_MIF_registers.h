  ...
  */
  ...
  union
  {
    struct
    {
      ...
      unsigned int   nvrAddressLSW : 16;    /* 00000108.F:0  R/W      Default = 0x00 */
      unsigned int   nvrAddressMSW : 8;    /* 00000108.17:10 */
                     /* NVR Address [17:0]
                          */
    ...
    struct
    {
      /* NOTE actually is one nvrData bitfield, divided for compatibility with EUR regmap */
                    /*! \brief 0000010C.F:0 R/W NVR Data [F:0]
                        AQ_GlobalNvrInterface_ATL.u3.bits_3.nvrDataLSW
      ...
      unsigned int   nvrDataLSW : 16;    /* 0000010C.F:0  R/W      Default = 0x0000 */
      unsigned int   nvrDataMSW : 16;    /* 0000010C.1F:10 */
                     /* NVR data
                          */
    } bits_3;
    uint32_t word_3;
